...
<div id="page">
 ...
 System.out.println("inboxgfhgf "+roleid);
...
/*
 PreparedStatement st1=con.prepareStatement("select  emailid from  CMS_STAFF  where roleid='"+id+"' and loginid='"+loginid+"');
  ResultSet rss=st1.executeQuery();
 if(rss.next()){
	staffemail=rss.getString(1);
	}
...
String sql="select  emailid from  CMS_ROLE where roleid='"+id+"' and associateid="+associateid;
...
String s2="select  emailid from  CMS_ROLE where roleid='"+adminid+"'";
System.out.println(s2);
 
String s3="select COMPLAINTDESC ,email,complaintid  from  CMS_COMPLAINT where toemail='"+email+"'";
...
<tr>
		   ...
		   <td align="center" >
		   <a href="atmteammail.jsp?sub=<%=sub%>&from=<%=adminemail%>&cid=<%=cid%>"><%=sub%></a></td>
