...
<div id="page">
	<div id="content1">
		<div class="post">
			<h2 class="title">&nbsp;</h2>
	        <div class="entry">
				<form name=form1 action="custfwd.jsp" >
				  <fieldset>
...
String email=(String)session.getAttribute("email");
 System.out.println("lemail in ijsp"+email);
...
try{
 /*Class.forName(driver);
  ...
  con=DBConnectionFactory.getConnection();
   ...
   PreparedStatement st=con.prepareStatement("select  emailtext ,email  from  CMS_COMPLAINT  where COMPLAINTID="+cid+" and  toemail='"+email+"'");
   ResultSet rs=st.executeQuery();
   rs.next();
   
   String content=rs.getString(1);
   String email22=rs.getString(2);
...
<tr >
  <td height="20" colspan="2"><div align="center">
    <div align="center">
      <input type="submit" value="REPLY" style="color: #000080; font-family: Verdana; font-weight: bold" />
    </div></td>
  </tr>
</table>
				      <p><br />
